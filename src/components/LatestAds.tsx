...
export default async function LatestAds({
  ...
  return (
    <section id="ogloszenia" className="bg-white text-slate-900">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          {filtersActive && (
            <Link
              href="/#ogloszenia"
              className="inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-5 py-3 font-bold text-slate-800 shadow-sm transition hover:bg-slate-50"
            >
              Wyczyść filtry
            </Link>
          )}
